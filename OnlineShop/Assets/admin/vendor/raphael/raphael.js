                ...
                !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ =
                    function(eve) {
                        ...
                        R.rgb = cacher(function(r, g, b) {
                            ...
                            return "#" +
                                (16777216 | round(b) | (round(g) << 8) | (round(r) << 16)).toString(16).slice(1);
                        });
                        /*\
                         * Raphael.getColor
                         [ method ]
                            ...
                            path2curve = R._path2curve = cacher(function(path, path2) {
                                    ...
                                    var p = pathToAbsolute(path),
                                        ...
                                        processPath = function(path, d, pcom) {
                                            ...
                                            case "S":
                                                if (pcom == "C" || pcom == "S"
                                                    ...
                                                    ny =
                                                        d.y * 2 -
                                                        d.by; // command's control point relative to the current point.
                                        ...
                                        fixArc = function(pp, i) {
                                            if (pp[i].length > 7) {
                                                ...
                                                while (pi.length) {
                                                    pcoms1[i] =
                                                        "A"; // if created multiple C:s, their original seg is saved
                                    ...
                                    for (var i = 0, ii = mmax(p.length, p2 && p2.length || 0); i < ii; i++) {
                                        ...
                                        p[i] =
                                            processPath(p[i],
                                                attrs,
                                                pcom); // Previous path command is inputted to processPath
                                ...
                                R[eventName] = elproto[eventName] = function(fn, scope) {
                                    if (R.is(fn, "function")) {
                                        ...
                                        this.events.push({
                                            name: eventName,
                                            f: fn,
                                            unbind: addEvent(this.shape || this.node || g.doc,
                                                eventName,
                                                fn,
                                                scope || this)
                                        });
                       ...
                       \*/
                        ...
                        var curveslengths = {},
                            getPointAtSegmentLength = function(p1x, p1y, c1x, c1y, c2x, c2y, p2x, p2y, length) {
                                if (length == null) {
                                    ...
                                    return R.findDotsAtSegment(p1x,
                                        p1y,
                                        c1x,
                                        c1y,
                                        c2x,
                                            ...
                                            if (len + l > length) {
                                                if (subpath && !subpaths.start) {
                                                    point = getPointAtSegmentLength(x,
                                                        ...
                                                        length - len);
                                                    sp += [
                                                        "C" + point.start.x, point.start.y, point.m.x, point.m.y,
                                                        point.x, point.y
                                                    ];
                                                    if (onlystart) {
                                                        return sp;
                        ...
                        elproto.pause = function(anim) {
                            for (var i = 0; i < animationElements.length; i++)
                                if (animationElements[i].el.id == this.id &&
                                    ...
                                    if (eve("raphael.anim.pause." + this.id, this, animationElements[i].anim) !==
                                        false) {
                        ...
                        paperproto.getFont = function(family, weight, style, stretch) {
                            ...
                            if (!font) {
                                var name = new RegExp("(^|\\s)" + family.replace(/[^\w\d\s+!~.:_-]/g, E) + "(\\s|$)",
                                    "i");
                        ...
                        paperproto.print = function(x, y, string, font, size, origin, letter_spacing, line_spacing) {
                            ...
                            if (font) {
                                ...
                                var bb = font.face.bbox[split](separator),
                                    ...
                                    shifty = 0,
                                    height = +bb[1] +
                                        (origin == "baseline" ? lineHeight + (+font.face.descent) : lineHeight / 2);
                                for (var i = 0, ii = letters.length; i < ii; i++) {
                                    ...
                                    if (curr && curr.d) {
                                        path += R.transformPath(curr.d,
                                            [
                                                "t", shift * scale, shifty * scale, "s", scale, scale, top, height, "t",
                                                (x - top) / scale, (y - height) / scale
                                            ]);
                                    }
                                }
                            }
                    ...
                    (typeof module != "undefined" && module.exports)
                        ...
                        : (true
                            ? (!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ =
                                    function() { return eve; }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
                                ...
                                if (type != "none") {
                                    ...
                                    if (!marker) {
                                        ...
                                        use = $($("use"),
                                            {
                                                "xlink:href": "#" + pathId,
                                                transform: (isEnd ? "rotate(180 " + w / 2 + " " + h / 2 + ") " : E) +
                                                    "scale(" +
                                                    w / t +
                                                    "," +
                                                    h / t +
                        ...
                        addDashes = function(o, value, params) {
                            ...
                            if (value) {
                                var width = o.attrs["stroke-width"] || "1",
                                    butt = { round: width, square: width, butt: 0 }[o.attrs["stroke-linecap"] ||
                        ...
                        setFillAndStroke = function(o, params) {
                            ...
                            for (var att in params) {
                                if (params[has](att)) {
                                    ...
                                    case "fill":
                                        ...
                                        if (!clr.error) {
                                            ...
                                            if ("opacity" in attrs || "fill-opacity" in attrs) {
                                                var gradient = R._g.doc.getElementById(node.getAttribute("fill")
                                                    .replace(/^url\(#|\)$/g, E));
                                                if (gradient) {
                                                    var stops = gradient.getElementsByTagName("stop");
                                                    $(stops[stops.length - 1],
                                                        {
                                                            "stop-opacity": ("opacity" in attrs ? attrs.opacity : 1) *
                                    ...
                                    case "fill-opacity":
                                        if (attrs.gradient) {
                                            gradient = R._g.doc.getElementById(node.getAttribute("fill")
                                                .replace(/^url\(#|\)$/g, E));
                                            if (gradient) {
                    ...
                    var addArrow = function(o, value, isEnd) {
                        ...
                        setFillAndStroke = function(o, params) {
                            ...
                            if (params.path && o.type == "path" || newpath) {
                                node.path = path2vml(~Str(a.path).toLowerCase().indexOf("r")
                            ...
                            if (isOval) {
                                var cx = +a.cx,
                                    ...
                                    rx = +a.rx || +a.r || 0,
                                    ry = +a.ry || +a.r || 0;
                                node.path = R.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x",
                                    round((cx - rx) * zoom),
                                    round((cy - ry) * zoom),
                                    round((cx + rx) * zoom),
                                    round((cy + ry) * zoom),
                            ...
                            if (params.opacity != null ||
                                ...
                                params["stroke-linecap"] &&
                                (stroke.endcap = params["stroke-linecap"] == "butt"
                                    ? "flat"
                            ...
                            if (res.type == "text") {
                                ...
                                res.textpath.string &&
                                (span.innerHTML = Str(res.textpath.string).replace(/</g, "&#60;")
                                    .replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
                                ...
                                (res.path.v = R.format("m{0},{1}l{2},{1}",
                                    round(a.x * zoom),
                                    round(a.y * zoom),
                                    round(a.x * zoom) + 1));
                                var dirtyattrs = [
                            ...
                            gradient = Str(gradient).replace(R._radial_gradient,
                                function(all, fx, fy) {
                                    ...
                                    if (fx && fy) {
                                        ...
                                        fy = toFloat(fy);
                                        pow(fx - .5, 2) + pow(fy - .5, 2) > .25 &&
                                            (fy = math.sqrt(.25 - pow(fx - .5, 2)) * ((fy > .5) * 2 - 1) + .5);
                                        fxfy = fx + S + fy;
                                    }
                                    return E;
                                });
